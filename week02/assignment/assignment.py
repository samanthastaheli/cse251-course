...
Submission Comment:
My assignment meets requirements. My code outputs the correct data. 
I made 94 calls to the swapi server and the total time was 68.79010340.
I worked with my team on this, so that is why we have similar code. 
------------------------------------------------------------------------------
"""
